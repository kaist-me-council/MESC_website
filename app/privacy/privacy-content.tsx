        ...
        <>
          ...
          <ol>
            ...
            <li>
              ...
              선택 항목, 입금·수령·회신 상태를 행사 운영·물품 전달·환불·교환 목적으로 수집합니다. 캠페인에 따라 학생회가
              추가 문항(예: 참석 여부, 환불 계좌)을 둘 수 있으며, 그 답변도 같은 목적·같은 기간 동안 함께 보관합니다. 취소 비밀번호는 원문이 아닌 단방향 해시로만 저장합니다. 학번은 본인 대조용 일방향
              해시(salt 포함)로만 저장하며 원문은 저장하지 않습니다. 연락처와 추가 문항 답변은 학생회 관리자만 열람합니다.
            </li>
          </ol>
          ...
          <ul>
            ...
            <li>이벤트 신청·구매 기록은 캠페인 마감 후 180일(정산 완료) 지나면 개인정보 항목(이름·학번 해시·이메일·전화·입금자명·메모·추가 문항 답변)을 익명화하며, 항목·금액·상태 등 통계 정보만 남깁니다.</li>
